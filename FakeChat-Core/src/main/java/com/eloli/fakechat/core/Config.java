...
public class Config {
    ...
    public static Map<String,MainConfiguration.PlayerSetting> replace;
    ...
    public static void init() throws IOException {
        ...
        try {
            ...
            FakeChatCore.warn("Can't read Configure file", e);
            return;
        }
        ...
        try {
            ...
            FakeChatCore.warn("Can't save Configure file", e);
            return;
        }
    ...
    protected static Class<? extends Migrater> getMigrater(int version) throws ClassNotFoundException {
        return (Class<? extends Migrater>)
                Class.forName("com.eloli.fakechat.core.config.migrates.MigrateFrom" + version);
    }
    ...
    protected static Class<? extends Configure> getConfigure(int version) throws ClassNotFoundException {
        if (version == CURRENT_VERSION) {
            ...
            return (Class<? extends Configure>)
                    Class.forName("com.eloli.fakechat.core.config.migrates.MainConfiguration" + version);
        }
    }
