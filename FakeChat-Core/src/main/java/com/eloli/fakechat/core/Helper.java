...
public class Helper {
    ...
    public static String getConfigPath(String filename) {
        return Paths.get(FakeChatCore.basePath, filename).toString();
    }
    ...
    public static void saveResource(String resourcePath, boolean replace) {
        ...
        File outFile = new File(FakeChatCore.basePath, resourcePath);
        int lastIndex = resourcePath.lastIndexOf('/');
        File outDir = new File(FakeChatCore.basePath, resourcePath.substring(0, Math.max(lastIndex, 0)));
        ...
        try {
            ...
            FakeChatCore.warn("Could not save " + outFile.getName() + " to " + outFile, ex);
        }
    }
